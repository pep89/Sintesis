...
$linea = $reg["idgrup"].$sep.$reg['any'].$sep.$reg['nomcurs'].$sep.$reg['acronimcurs'].$sep.$reg['nomclase'].$sep.$reg['codiclase'].$sep.$reg['horesclase']." H/Total X curso".$sep.$reg['nomgrup'].$sep.$reg['horesgrup']." H/Semana X clase" ."\n";
fwrite($f,$linea);
